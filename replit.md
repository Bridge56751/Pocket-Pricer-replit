...
**Current version**: 1.3.1 / build 51
...
- **Mar 2026**: eBay search query cleaning v2: strips specs (CPI, DPI, Hz, mm, oz, g, etc.), marketing fluff (Ultra-Lightweight, Super Light, etc.), filler words (with, and, for, the, etc.), retailer names (Walmart, Amazon, Target, Nordstrom, etc.), colors/finishes (Gray, Matte, Glossy, etc.), product category words (Sunglasses, Sneakers, Plush, etc.), sizes, eBay abbreviations; 6-word / 80-char cap for exact, 4-word cap for broad; broad also strips clothing types, materials, tech specs, accessories, and size descriptors
